...
Lote l1_2 = {"SC02", 150, {15, 9, 2026}, NULL};
Lote l1_1 = {"SC01", 100, {10, 8, 2026}, &l1_2};
Lote l2_1 = {"IG01", 200, {20, 7, 2025}, NULL};
Lote l3_1 = {"QJ01", 12, {30, 6, 2025}, NULL};
//Lote vencido para teste
Lote l4_1 = {"LT01", 3, {15, 5, 2024}, NULL};

Produto p4 = {4, "Leite", &l4_1, NULL};
Produto p3 = {3, "Queijo", &l3_1, &p4};
Produto p2 = {2, "Iogurte", &l2_1, &p3};
...
void novoLog(TipoHistorico tipo, const char* nome, const char* num, int qtd){
...
void cadastrarProduto(){
    ...
    printf("Digite o numero do lote (ex: LT04): ");
    scanf("%s", nomeLote);
    printf("Digite a quantidade de produtos no lote: ");
    scanf("%d", &qtd);
